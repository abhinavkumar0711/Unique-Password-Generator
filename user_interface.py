...
lowercase_slider = Scale(CustomLen_frame, orient=VERTICAL, from_=0, to=30, sliderlength=18,
...
uppercase_slider = Scale(CustomLen_frame, orient=VERTICAL, from_=0, to=30, sliderlength=18,
...
digits_slider = Scale(CustomLen_frame, orient = VERTICAL, from_=0, to=30, sliderlength=18,
...
Symbols_slider = Scale(CustomLen_frame, orient=VERTICAL, from_=0, to=30, sliderlength=18,
